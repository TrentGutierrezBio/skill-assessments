...
A15: the -o gives us an progress bar to see how our download is going and athal.fa.gz is the data we are downloading. 
...
A20: It is sperating the two commands we wrote in our 1 line, first the zcat command will run and then immediately the head command will look at our athal data. 
...
A26: $fastq-dump --gzip --skip-technical --clip SRR047122
